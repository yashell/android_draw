...
public class Broke extends View {
    private static final String TAG = "ExplosionField";
    private static final Canvas mCanvas = new Canvas();
    private BrokeAnimation animator;

    public Broke(Context context) {
        super(context);
    }
    ...
    public void explode(final View view, final AnimatorListenerAdapter listener) {
        ...
        animator = new BrokeAnimation(this, createBitmapFromView(view), rect);
