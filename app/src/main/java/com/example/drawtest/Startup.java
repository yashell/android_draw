...
public class Startup extends AppCompatActivity {
    ...
    private void StartAnimation(){
        ...
        ObjectAnimator animatorB_2 = ObjectAnimator.ofFloat(imgA, "alpha", 1f, 0.3f);
        ...
        //step 3
        ObjectAnimator animatorC = ObjectAnimator.ofFloat(imgA, "alpha", 1f, 0.0f);
        ...
        ObjectAnimator animatorE_7 = ObjectAnimator.ofFloat(imgB, "scaleX", 1f, 8500f);
        ObjectAnimator animatorE_8 = ObjectAnimator.ofFloat(imgB, "scaleY", 1f, 8500f);
